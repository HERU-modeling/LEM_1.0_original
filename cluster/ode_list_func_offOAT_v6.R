...
dS1 = rho*sum(x) - psi*S1 + ws*S2 - lambda*S1                - mo[1]*S1 - oat.e*S1 + oat.q*x.oat[1] - rho.m*sum(x[4:19])
...
dS2 = psi*S1 + wp*Sp      - ws*S2 - lambda*S2                - mo[2]*S2 - oat.e*S2 + oat.q*x.oat[2] - eta*(S2+S1)
