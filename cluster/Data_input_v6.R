...
diag18.obs  = data.matrix(subset(data.frame(read.xlsx("target.xlsx", sheet="diag18.obs",  colNames =T)), city == CITY)[ , -1])
ndiag18.obs = data.matrix(subset(data.frame(read.xlsx("target.xlsx", sheet="ndiag18.obs", colNames =T)), city == CITY)[ , -1])
death18.obs = data.matrix(subset(data.frame(read.xlsx("target.xlsx", sheet="death18.obs", colNames =T)), city == CITY)[ , -1])
obs.inc.all = subset(data.frame(read.xlsx("target.xlsx", sheet="obs.inc.all", colNames =T)), city == CITY)[ , -1]
obs.inc.msm = subset(data.frame(read.xlsx("target.xlsx", sheet="obs.inc.msm", colNames =T)), city == CITY)[ , -1]
