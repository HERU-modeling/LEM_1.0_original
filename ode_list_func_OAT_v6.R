...
dS1 = rho*sum(x) - psi*S1 + ws*S2 - lambda*S1                - mo[1]*S1 + oat.e*x.offoat[1] - oat.q*S1 - rho.m*sum(x[4:19])

#dS2 = psi*S1  + wp*Sp     - ws*S2 - lambda*S2   - mu_mat*S2 - mo[2]*S2 + oat.e*x.offoat[2] - oat.q*S2 - eta*(S2+S1)
dS2 = psi*S1  + wp*Sp     - ws*S2 - lambda*S2                - mo[2]*S2 + oat.e*x.offoat[2] - oat.q*S2 - eta*(S2+S1)
