...
free.par  = read.xlsx(paste0("free_par_", CITY, ".xlsx"), sheet="free.par")
free.par.info = as.list(2)      #Contains information for free.par
free.par.info$names   = unique(free.par$par)
free.par.info$plength = as.numeric(table(factor(free.par$par, levels=free.par.info$names)))
